...
<!-- /.primary-menu -->
	...
	<!-- SLIDE  -->
		...
		<img src="<?php echo URL;?>images/page-home/manutencao.jpg" style='background-color:#666666' alt=""  data-lazyload="images/page-home/03.png" data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" data-bgparallax="1" class="rev-slidebg" data-no-retina>
		</div>
        <!-- LAYERS -->
      ...
      <div class="col-xs-12">
       <br>
	    <?php 
				...
				*/
				$sql = Cms::conteudoPrincipal(3, NULL, 1, 'ORDER BY ctn.listorder ASC');
